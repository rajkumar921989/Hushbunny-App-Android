            ...
            MomentAdapter(resourceProvider = resourceProvider, onItemClick = { view: View, position: Int, type: String, item: MomentListingModel ->
                when (type) {
                    ...
                    resourceProvider.getString(R.string.comments) -> {
                        ...
                        findNavController().navigate(ProfileFragmentDirections.actionCommentFragment(momentID = item._id.orEmpty(), parentOneId = parentOne, parentTwoId = parentTwo))
                    }
                ...
                if (isParentFound) {
                    findNavController().navigate(
                        ProfileFragmentDirections.actionKidsProfileFragment(
